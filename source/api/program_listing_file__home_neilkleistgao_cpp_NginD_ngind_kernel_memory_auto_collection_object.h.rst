...
.. _program_listing_file__home_neilkleistgao_cpp_NginD_ngind_kernel_memory_auto_collection_object.h:

Program Listing for File auto_collection_object.h
=================================================

|exhale_lsh| :ref:`Return to documentation for file <file__home_neilkleistgao_cpp_NginD_ngind_kernel_memory_auto_collection_object.h>` (``/home/neilkleistgao/cpp/NginD/ngind/kernel/memory/auto_collection_object.h``)
