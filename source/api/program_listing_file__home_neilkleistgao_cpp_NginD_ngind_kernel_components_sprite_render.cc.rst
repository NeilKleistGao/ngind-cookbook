...
.. _program_listing_file__home_neilkleistgao_cpp_NginD_ngind_kernel_components_sprite_render.cc:

Program Listing for File sprite_render.cc
=========================================

|exhale_lsh| :ref:`Return to documentation for file <file__home_neilkleistgao_cpp_NginD_ngind_kernel_components_sprite_render.cc>` (``/home/neilkleistgao/cpp/NginD/ngind/kernel/components/sprite_render.cc``)
