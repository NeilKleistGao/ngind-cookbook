...
.. _program_listing_file__home_neilkleistgao_cpp_NginD_ngind_kernel_math_vector.h:

Program Listing for File vector.h
=================================

|exhale_lsh| :ref:`Return to documentation for file <file__home_neilkleistgao_cpp_NginD_ngind_kernel_math_vector.h>` (``/home/neilkleistgao/cpp/NginD/ngind/kernel/math/vector.h``)
