...
.. _program_listing_file_ngind_kernel_render_perspective.cc:

Program Listing for File perspective.cc
=======================================

|exhale_lsh| :ref:`Return to documentation for file <file_ngind_kernel_render_perspective.cc>` (``ngind/kernel/render/perspective.cc``)
