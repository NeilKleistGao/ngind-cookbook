...
.. _program_listing_file_ngind_kernel_filesystem_file.cc:

Program Listing for File file.cc
================================

|exhale_lsh| :ref:`Return to documentation for file <file_ngind_kernel_filesystem_file.cc>` (``ngind/kernel/filesystem/file.cc``)
