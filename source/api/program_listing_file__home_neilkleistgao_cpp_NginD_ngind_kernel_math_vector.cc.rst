...
.. _program_listing_file__home_neilkleistgao_cpp_NginD_ngind_kernel_math_vector.cc:

Program Listing for File vector.cc
==================================

|exhale_lsh| :ref:`Return to documentation for file <file__home_neilkleistgao_cpp_NginD_ngind_kernel_math_vector.cc>` (``/home/neilkleistgao/cpp/NginD/ngind/kernel/math/vector.cc``)
