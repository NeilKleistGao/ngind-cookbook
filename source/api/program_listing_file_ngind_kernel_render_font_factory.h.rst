...
.. _program_listing_file_ngind_kernel_render_font_factory.h:

Program Listing for File font_factory.h
=======================================

|exhale_lsh| :ref:`Return to documentation for file <file_ngind_kernel_render_font_factory.h>` (``ngind/kernel/render/font_factory.h``)
