...
.. _program_listing_file_ngind_kernel_log_logger.h:

Program Listing for File logger.h
=================================

|exhale_lsh| :ref:`Return to documentation for file <file_ngind_kernel_log_logger.h>` (``ngind/kernel/log/logger.h``)
