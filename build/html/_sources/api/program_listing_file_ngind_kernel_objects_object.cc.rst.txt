...
.. _program_listing_file_ngind_kernel_objects_object.cc:

Program Listing for File object.cc
==================================

|exhale_lsh| :ref:`Return to documentation for file <file_ngind_kernel_objects_object.cc>` (``ngind/kernel/objects/object.cc``)
