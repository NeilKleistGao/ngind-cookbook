...
.. _program_listing_file_ngind_kernel_resources_resources_manager.cc:

Program Listing for File resources_manager.cc
=============================================

|exhale_lsh| :ref:`Return to documentation for file <file_ngind_kernel_resources_resources_manager.cc>` (``ngind/kernel/resources/resources_manager.cc``)
