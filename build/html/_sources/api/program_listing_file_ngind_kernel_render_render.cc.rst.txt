...
.. _program_listing_file_ngind_kernel_render_render.cc:

Program Listing for File render.cc
==================================

|exhale_lsh| :ref:`Return to documentation for file <file_ngind_kernel_render_render.cc>` (``ngind/kernel/render/render.cc``)
